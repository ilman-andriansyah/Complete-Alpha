...
{	
	...
	{
		system("cls");
		cout<<"nnnntttt   Loading "<<'n'<<'t'<<'t';cout<<endl;
		for(int j=1;j<=i;j++)
		cout<<"xB2";cout<<"nnt "<<2*i<<"%";
		if( i > 1 && i < 20)cout<<"nntCreating Temporary files";
		else if( i > 20 && i<40)cout<<"nntAccessing Main Memory";
		else if(i >40 && i<48)cout<<"nntAccessing Cache";
		else cout<<"nntComplete. Press Enter to Continue ";
	}
	*/
	...
	for (int i=0;i<75;++i)
	{
		...
		cout << "nnnnnnnnttttLoading " << (int)l << " %nn";
		...
		cout << (char)186 << ' ';print(i, a);print(75 - i, ' ');cout << (char)186 << endl;
		//forth line
		cout << (char)200;print(76, 205);cout << (char)188;cout << "nnttTip : After loading press any key to continue.";l = l + 1.33333333;Sleep(z);
	}
	/* _getch();return 0; */
	getche();welcome();
}
...
int login()
{
    ...
    cout << "xB2xB2xB2xB2xB2xB2xB2xB2xB2xB2xB2xB2xB2xB2xB2xB2xB2xB2xB2xB2xB2xB2xB2xB2xB2xB2xB2xB2xB2xB2xB2xB2xB2xB2xB2xB2xB2xB2xB2xB2xB2xB2xB2xB2" << endl;
...
int ceremony()
{
	for(int i=0;i<50;i++)cout<<endl;cout << rocket;int j=300000;for(int i=0;i<50;i++){usleep(j);j=(int)(j*0.9);cout<<endl;}cout << "Visit http://ifannuddin.com ! " <<endl;cout<<endl;cout<<endl;cout << "Tekan [Enter] untuk melanjutkan : ";getche();login();return 0;
}
int program_dasar()
{
    program_dasar:system("cls");string pilihan;
	cout << "" << endl;
...
int billing_warung_telekomunikasi()
{
	...
	main()
	{
		...
		printf("nTOTAL DURASI 	= %d : %d : %d n",lj,lm,ld);
		printf("TOTAL PULSA 	= %dn",jp);
...
int billing_warung_telekomunikasi_2()
{
	...
	main()
	{
		...
		printf("Mulai bicara : %d : %d : %dn",mj,mm,md);
		...
		printf("Selesai bicara : %d : %d : %dn",sj,sm,sd);
		tj=sj-mj;tm=sm-mm;td=sd-md;
		printf("Total Durasi : %d : %d : %dn",tj,tm,td);
		tjm=tj*60;tp=tm+tjm;
		if(td>=1){tp++;}
		printf("Total pulsa %dn",tp);jb=tp*150;
		printf("Jumlah bayar Rp.%d",jb);
		getch();
	}
	*/
...
int daftar_nilai_mahasiswa()
{
	...
	printf("nNilai Rata-rata = %.2f",nr);
	printf("nNilai terbesar = %d",nt);
	getch();
	}
	*/
...
int hitung_cashback_inap_hotel()
{
	...
	{ int tci,tco,li;float tid,t_bayar,cash,c_back; char nt[10];
	 ...
	 printf("LAMA MENGINAP			= %d HARIn",li);
	 printf("TOTAL BAYAR			= Rp. %.2fn",t_bayar);
...
int hitung_denda_bayar_listrik()
{
	...
	printf("Tegangan 1 = 450n");
	printf("Tegangan 2 = 900n");
	printf("Tegangan 3 = 1200n");
	tg=getche();
	switch(tb>20)
	...
	printf("nBesarnya denda Rp. %d",denda);
	getch();
	}
	*/
	//Default 2
...
int hitung_gaji_karyawan()
{
	...
	*/
	...
	void cetak_gaji_pegawai(void)
	{
	 printf("Gaji pokok    = Rp. %.2fn",gp);
	 printf("Tunjangan SI  = Rp. %.2fn",tsi);
	 printf("Upaha Lembur  = Rp. %.2fn",ul);
	 printf("____________________________n");
	 printf("Total gajih   = Rp. %.2fn",tg);
	 printf("PPH           = Rp. %.2f(-)n",pph);
	 printf("____________________________n");
	 printf("Gaji Bersih   = Rp. %.2fn",gb);
	}
...
int hitung_konsumsi_rata_rata_sepeda()
{
	...
	{ int j,l; float rata_rata;
	 clrscr();
	 printf("***MENGHITUNG KONSUMSI RATA-RATA SEPEDA***n");
...
int hitung_luas_segitiga()
{
	...
	puts("******************************");
	printf("nPANJANG ALAS SEGITIGA = "); scanf("%f",&pas);
	printf("nTINGGI SEGI TIGA      = "); scanf("%f",&tst);
	luas_sgt=0.5*pas*tst;
	puts("---------------------------------");
	printf("LUAS SEGITIGA ADALAH %.2Fnn",luas_sgt);
...
int hitung_nilai_rata_rata_item()
{
	...
	{ int b1,j1,b2,j2; float js,rata_rata;
	 clrscr();
	 printf("***MENGHITUNG NILAI RATA-RATA ITEM***n");
...
int hitung_perimeter_dan_luas_persegi_panjang()
{
	...
	{ int p,l,kl,luas;
	 ...
	 kl= 2*(p+l);
	 luas= p*l;
	 printf("Perimeter persegi panjang = %d inchin",kl);
...
int hitung_total_biaya_dari_perhitungan_jarak_dan_bensin()
{
	...
	{ int jr; float liter,t_biaya;
	 ...
	 printf("Bensin yang dihabiskan   = %.2f Litern ",liter);
...
int kalkulator_sederhana()
{
	...
	{ int a,b;
	 ...
	 printf("%d : %d = %dn",a,b,(float)a/b);
	 printf("%d mod %d = %dn",a,b,a%b);
	 printf("%d div %d  = %dn",a,b,a/b);
...
int konversi_suhu()
{
	...
	{ int cel; float rea,fah,kel;
	 clrscr();
	 printf("Konversi Suhunn");
	 printf("Input SUhu Dalam Derajat Celcius ="); scanf("%d",&cel);
	 rea=(float) 4/5*cel; fah=(float) 9/5*cel+32; kel=273+cel;
	 printf("Hasil Konversinya adalah =n");
	 printf("%.2fReamurn%.2fFahrenheitn%.2fKelvinn",rea,fah,kel);
	 getch();
	}
	*/
...
int menentukan_bilangan_ganjil_atau_genap()
{
	...
	clrscr();
		...
		printf("Masukan Angka : ");scanf("%d",&angka);
			if(angka%2==0){printf("%d adalah bilangan genap n",angka);} 
		else{printf("%d adalah bilangan ganjil n",angka);}
			getch();
	}
	*/
...
int menentukan_bilangan_positif_atau_negatif()
{
	...
	main()
	{
	 ...
	 if(angka>=0){printf("%d adalah angka positifn",angka);}
	 else{printf("%d adalah angka negatifn",angka);}
	 getch();
	}
	*/
...
int menentukan_kategori_tinggi_badan()
{
	...
	main()
	{
		...
		if(tb>=0 && tb<=100){printf("Kategori Tinggi saudara adalah Pendek n");}
		else if(tb>=101 && tb<150){printf("Kategori Tinggi saudara adalah Sedang n");}
		else if(tb>=151 && tb>151){printf("Kategori Tinggi saudara adalah Tinggi n");}
		getch();
	}
	*/
...
int pembagian_dengan_pengurangan_berulang()
{
	...
	main()
	{
	 clrscr();
	 int bil1,bil2;
	 printf("Pembagian menggunakan Pengurangan Berulangn");
	 do
	 {
	 ...
	 while(remainder>0)
	 {
		printf("%d - %d = %d n", remainder,bil2,(remainder-bil2));
		remainder-=bil2;
		subtractionCount++;
	 }
	 printf("nn%d / %d = %dn",bil1,bil2,subtractionCount);
	 getch();
	}
	*/
...
int perkalian_2_buah_bilangan_dengan_menggunakan_konsep_penjumlahan()
{
	...
	do{
	   ...
	   if(b1>=0 && b2>=0){
	   puts("--------------------------------");
	   printf("Bilangan Bulat Ke-1 = %dn",b1);
	   printf("Bilangan Bulat Ke-2 = %d ",b2);
	   printf("nMaka %d x %d = %d ",b1,b2,b1*b2);
	   printf("n%d Maka didapatkan dengan cara : ",b1*b2);
	   for(i=1;i<=b2;i++){
	   printf("%d ",b1);
	   if (i < b2){
	   printf("+ ");
...
int program_combine_3_kasus()
{
	...
	main()
	{
		...
		do
		{
			...
			puts("2.Jawaban no.2");
			puts("3.Jawaban no.3");
			printf("Pilih 1/2/3 = ");pilih=getche();printf("n");
			switch(pilih)
			{
				...
				case '2' :  printf("Jenis kendaraan 1.motor 2.mobil = ");
							...
							printf("Biaya Parkir Rp. %dn",bayar);
							break;
				case '3' :  printf("Jumlah bilangan yang akan diinput = ");
							...
							printf("Jumlah Bilangan Genap  = %dn",jgn);
							printf("Jumlah Bilangan Ganjil = %dn",jgl);
							break;
			}//end switch
			fflush(stdin);
			printf("nMau coba lagi ? ");scanf("%c",&jawab);
